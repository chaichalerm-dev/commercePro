...
return [
    ...
    'ascii' => ':attribute ต้องมีเฉพาะตัวอักษรและสัญลักษณ์แบบไบต์เดียว',
    ...
    'extensions' => ':attribute ต้องมีนามสกุลไฟล์ใดค่าหนึ่งต่อไปนี้: :values',
    ...
    'gte' => [
        'array' => ':attribute ต้องมีอย่างน้อย :value รายการขึ้นไป',
    ...
    'missing_with_all' => ':attribute ต้องไม่มีอยู่เมื่อมี :values ครบทุกตัว',
    ...
    'password' => [
        ...
        'uncompromised' => ':attribute นี้เคยรั่วไหลในข้อมูลที่หลุด กรุณาเลือก :attribute อื่น',
    ],
    ...
    'present_with_all' => ':attribute ต้องมีอยู่เมื่อมี :values ครบทุกตัว',
    ...
    'prohibits' => ':attribute ห้ามระบุร่วมกับ :other',
    ...
    'required_with_all' => 'กรุณากรอก :attribute เมื่อมี :values ครบทุกตัว',
