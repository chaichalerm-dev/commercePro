...
<form method="POST"
    ...
    <div class="space-y-4 lg:col-span-2">
        ...
        <div class="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
            <h2 class="font-semibold text-gray-900">ข้อมูลสินค้า</h2>

            <div class="mt-4 grid gap-4 sm:grid-cols-2">
                <div class="sm:col-span-2">
                    <label for="name" class="block text-sm font-medium text-gray-700">ชื่อสินค้า <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label for="slug" class="block text-sm font-medium text-gray-700">Slug <span class="text-xs text-gray-400">(เว้นว่าง = สร้างอัตโนมัติ)</span></label>
                ...
                <div>
                    <label for="sku" class="block text-sm font-medium text-gray-700">SKU <span class="text-xs text-gray-400">(เว้นว่าง = สร้างอัตโนมัติ)</span></label>
        ...
        {{-- Pricing & stock --}}
        <div class="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
            <h2 class="font-semibold text-gray-900">ราคาและสต็อก</h2>
            <div class="mt-4 grid gap-4 sm:grid-cols-3">
                <div>
                    <label for="price" class="block text-sm font-medium text-gray-700">ราคาขาย (บาท) <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label for="compare_at_price" class="block text-sm font-medium text-gray-700">ราคาก่อนลด <span class="text-xs text-gray-400">(ถ้ามี)</span></label>
                ...
                <div>
                    <label for="stock" class="block text-sm font-medium text-gray-700">สต็อก <span class="text-red-500">*</span></label>
        ...
        <div class="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <h2 class="font-semibold text-gray-900">ตัวเลือกสินค้า (Variants)</h2>
            ...
            <div class="mt-3 space-y-2">
                <template x-for="(variant, index) in variants" :key="index">
                    <div class="grid grid-cols-2 items-end gap-2 rounded-xl bg-gray-50 p-3 sm:grid-cols-[1fr_1fr_120px_100px_auto]">
                        ...
                        <div>
                            <label class="text-xs text-gray-500">ประเภท (เช่น Size)</label>
    ...
    <div class="space-y-4">
        <div class="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
            <h2 class="font-semibold text-gray-900">การเผยแพร่</h2>

            <label for="category_id" class="mt-4 block text-sm font-medium text-gray-700">หมวดหมู่ <span class="text-red-500">*</span></label>
            ...
            <label for="status" class="mt-4 block text-sm font-medium text-gray-700">สถานะ</label>
            ...
            <label class="mt-4 flex cursor-pointer items-center gap-2">
                ...
                <span class="text-sm text-gray-700">แสดงเป็นสินค้าแนะนำ</span>
            </label>
        </div>
        ...
        <div class="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm"
            ...
            <h2 class="font-semibold text-gray-900">รูปหลัก</h2>
        ...
        {{-- Gallery --}}
        <div class="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
            <h2 class="font-semibold text-gray-900">รูปภาพเพิ่มเติม <span class="text-xs font-normal text-gray-400">(สูงสุด 6 รูป)</span></h2>

            @if ($product?->images->isNotEmpty())
                <div class="mt-3 grid grid-cols-3 gap-2">
                    @foreach ($product->images as $image)
                        <label class="group relative block cursor-pointer" title="ติ๊กเพื่อลบรูปนี้">
                ...
                <p class="mt-2 text-xs text-gray-400">ติ๊กที่รูปเพื่อลบเมื่อบันทึก</p>
            @endif
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('admin.products.index') }}" class="rounded-xl border border-gray-200 bg-white px-5 py-2.5 text-sm text-gray-600 transition hover:bg-gray-50">ยกเลิก</a>
        </div>
    </div>
</form>
