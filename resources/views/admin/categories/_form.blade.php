...
<form method="POST"
    ...
    <div class="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
        <div class="grid gap-4 sm:grid-cols-2">
            <div>
                <label for="name" class="block text-sm font-medium text-gray-700">ชื่อหมวดหมู่ <span class="text-red-500">*</span></label>
            ...
            <div class="flex items-end pb-2">
                <label class="flex cursor-pointer items-center gap-2">
                    ...
                    <span class="text-sm text-gray-700">เปิดใช้งานหมวดหมู่นี้</span>
                </label>
            </div>
        </div>

        <div class="mt-4" x-data="{ preview: {{ Js::from($category?->image_url) }} }">
            <label class="block text-sm font-medium text-gray-700">รูปภาพหมวดหมู่</label>
    ...
    <div class="flex gap-2">
        ...
        <a href="{{ route('admin.categories.index') }}" class="rounded-xl border border-gray-200 bg-white px-5 py-2.5 text-sm text-gray-600 transition hover:bg-gray-50">ยกเลิก</a>
    </div>
</form>
